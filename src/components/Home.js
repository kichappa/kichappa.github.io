        ...
        text={
          <>
            ...
            <p>
              ...
              and The Office. My favourite TV show is Psych. I spend my free
              time thinking of coding silly and creative design problems as part
              of the latter.
            </p>
            <p>
              I primarily code using Python. I have a love-hate relationship
              with the scipy library. ReactJS is my go-to library for web
              development; I hate jQuery. Although I don't have much experience,
              I thoroughly enjoy WebGL and Shaders programming. I have worked on
              three creative coding projects as of now. I am currently ideating
              on a fourth one.
            </p>
            <p>
              I am currently applying for graduate school in computation science
              and engineering programs in the Fall '23 admission cycle.
              Hopefully, I will get into my dream school. Let me leave you with
              some afterthoughts as you finish this very discontinuous brief
              about myself.
            </p>
            <p className="last">
              How do shapes affect the function of buildings? What are our
              limits as engineers? Can Python play GeoGuessr? I like to explore
              such questions, questions that deal with computation and design.
              My skills in engineering and my creative outlook help me work on
